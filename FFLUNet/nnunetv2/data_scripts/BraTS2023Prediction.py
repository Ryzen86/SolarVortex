...
def entry_point():
    ...
    parser.add_argument(
        ...
        required=False,
        default=None,
        help="Root input folder containing validation data for Brats2023",
    )
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Trainer Path from nnUNet_results folder",
    )

    args = parser.parse_args()
    generate_brats_predictions(args.i, args.tr, args.D)
